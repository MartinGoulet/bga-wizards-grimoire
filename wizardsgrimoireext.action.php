 ...
 * -----
 * 
 * wizardsgrimoireext.action.php
 *
 * WizardsGrimoireExt main action entry point
 *
 *
 ...
 * this.ajaxcall( "/wizardsgrimoireext/wizardsgrimoireext/myAction.html", ...)
 *
 */


class action_wizardsgrimoireext extends APP_GameAction {
   ...
   public function __default() {
      if (self::isArg('notifwindow')) {
         ...
         $this->view = "wizardsgrimoireext_wizardsgrimoireext";

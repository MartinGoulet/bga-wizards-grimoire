...
$this->card_types = [
 ...
 209 => [ 
  ...
  'class' => "Imagination",
  'description' => clienttranslate("Choose 1: Gain 2 mana cards, of gain mana until you have the same quantity of mana cards as your opponent"),
  'type' => WG_SPELL_TYPE_REGENERATION,
  'activation' => WG_SPELL_ACTIVATION_INSTANT,
  'cost' => 1,
  'icon' => WG_ICON_SET_SHIFTING_SAND_1,
 ...
 236 => [ 
  ...
  'class' => "SunkenSkull",
  'description' => clienttranslate("During your opponent's nex turn, the power of all mana is decreased by 1"),
  'type' => WG_SPELL_TYPE_UTILITY,
  'activation' => WG_SPELL_ACTIVATION_INSTANT,
  'cost' => 2,
  'icon' => WG_ICON_SET_SHIFTING_SAND_1,
